...
background = pygame.image.load("D:\Projects\Python Projects\Fruit-ninja-game-project\images\wood.png")                                  #game background
font = pygame.font.Font(os.path.join(os.getcwd(), 'D:\Projects\Python Projects\Fruit-ninja-game-project\comic.ttf'), 42)
score_text = font.render('Score : ' + str(score), True, (255, 255, 255))    #score display
lives_icon = pygame.image.load('D:\Projects\Python Projects\Fruit-ninja-game-project\images\white_lives.png')                    #images that shows remaining lives

# Generalized structure of the fruit Dictionary
def generate_random_fruits(fruit):
    fruit_path = "D:\\Projects\Python Projects\\Fruit-ninja-game-project\\images\\" + fruit + ".png"
    data[fruit] = {
...
def hide_cross_lives(x, y):
    gameDisplay.blit(pygame.image.load("D:\\Projects\\Python Projects\\Fruit-ninja-game-project\\images\\red_lives.png"), (x, y))

# Generic method to draw fonts on the screen
font_name = pygame.font.match_font('D:\Projects\Python Projects\Fruit-ninja-game-project\comic.ttf')
...
while game_running :
    if game_over :
        ...
        game_over = False
        player_lives = 3
        draw_lives(gameDisplay, 690, 5, player_lives, 'D:\\Projects\\Python Projects\\Fruit-ninja-game-project\\images\\red_lives.png')
        score = 0
        ...
        if value['throw']:
            ...
            if not value['hit'] and current_position[0] > value['x'] and current_position[0] < value['x']+60 \
                ...
                if key == 'bomb':
                    ...
                    half_fruit_path = "D:\\Projects\\Python Projects\\Fruit-ninja-game-project\\images\\explosion.png"
                else:
                    half_fruit_path = "D:\\Projects\\Python Projects\\Fruit-ninja-game-project\\images\\" + "half_" + key + ".png"
